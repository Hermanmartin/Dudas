...
LinkedList.prototype.add = function(value){
  ...
  while(current.next !== null){ 
    current = current.next; //*esto es un tema de sintaxis y .next podira ser . siguiente o estoy tomando la propiedad directamente
  }
...
miLista.add(5)
miLista.add(5)
miLista.add(5) //porque no me toma este 5
console.log(miLista)
